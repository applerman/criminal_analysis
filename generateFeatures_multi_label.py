                    ...
                    with open(lableFilename, 'wb') as f2:
                        ...
                        for row in spamreader:
                            ...
                            for (i, attr) in enumerate(row): #"2011-01-12 17:05:00", "
                                outputlabel = [0.0 for p in range(39)]
                                if attr_names[i] == 'Category':
                                    outputlabel[labelsDict[attr]]= 1.0
                                    writerLable.writerow(outputlabel)
...
def main():
    ...
    generateFeatureLabel('train.csv', 'trainFeature.csv', 'trainLabel_multi.csv')
