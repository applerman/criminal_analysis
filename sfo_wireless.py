...
def calculateMinDistanceFromWireless(data):
    with open('Recreation/Wireless_Service_Facility_Permits.csv', 'rb') as csvfile:
...
def test_calculateMinDistanceFromWireless():
    ...
    distances = calculateMinDistanceFromWireless(test_data)
    print distances

if __name__ == "__main__":
    test_calculateMinDistanceFromWireless()
