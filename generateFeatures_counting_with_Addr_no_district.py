                        ...
                        if countingFilename:
                            with open(countingFilename, 'rb') as countingFile:
                                ...
                                for row in spamreader:
                                    ...
                                    writerFeature.writerow(currFeature + countingFeature) # + 39 dim continuous PdDistrictStats + 4 dim distance features
...
def main():
    ...
    generateFeatureLabel('train.csv', 'trainFeatureCountingWithAddrNoDistrict.csv', 'trainLabel4.csv', 'trainFeatureAddr.csv')
    generateFeature('test.csv', 'testFeatureCountingWithAddrNoDistrict.csv', 'testFeatureAddr.csv')
