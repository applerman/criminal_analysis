                        ...
                        if countingFilename:
                            with open(countingFilename, 'rb') as countingFile:
                                ...
                                for row in spamreader:
                                    ...
                                    writerFeature.writerow(currFeature + statMatrix[indexPd] + countingFeature) # + 39 dim continuous PdDistrictStats + 4 dim distance features
...
def main():
    ...
    generateFeatureLabel('train.csv', 'trainFeatureWithCounting.csv', 'trainLabel3.csv', 'trainFeatureAddr.csv')
    generateFeature('test.csv', 'testFeatureWithCounting.csv', 'testFeatureAddr.csv')
