...
def calculateMinDistanceFromFood(data):
    with open('Recreation/Mobile_Food_Facility_Permit.csv', 'rb') as csvfile:
...
def test_calculateMinDistanceFromFood():
    ...
    distances = calculateMinDistanceFromFood(test_data)
    print distances

if __name__ == "__main__":
    test_calculateMinDistanceFromFood()
